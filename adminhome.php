...
if(isset($_POST['btn']))
{
			...
			$file_path=$_FILES['upload']['tmp_name'];
				...
				{ 
					...
					$img=$file_name;
					$qry=mysqli_query($conn,"insert into plant values('','$name','$dis','$ferti','$mois','$temp','$water','$weed','$space','$img')");
				if($qry)
							{
	
							echo "<script>alert('Plant details added sucessfully')</script>";
                            ...
                            <div class="main-menu position-relative">
                                <nav class="main-nav">
                                    <ul>
                                        ...
                                        <li>
                                        <a href="viewp.php">View Plants</a>
                                        </li>
                                        <li>
...
<form id="f1" name="f1" method="post" action="#"   enctype="multipart/form-data">
  <table width="38%" height="472" border="0" align="center" style="margin:0 auto;font-size:18px;">	
	

    <tr>
    
     <td colspan="2"  align="center" ><div class="style5"><h3>Add Plant Details</h></div></td>
      
    </tr>
	
    <tr>
    
      <td width="43%" height="48">Plant Name </span></td>
      <td width="57%"><label>
	...
	<tr>
	 ...
	 <tr>
      ...
      <td height="49">Plant Disease Name</td>
      <td><input name="dis" type="text"  required/></td>
     
    </tr>
	 <tr>
      
      <td height="49">Diesase Fertilizer Suggestion </td>
      <td><textarea name="ferti"   required></textarea></td>
     
    </tr>
	 <tr>
      
      <td height="49">Proper moisture level</td>
      <td><input name="mois" type="text"  required/></td>
     
    </tr>
	 <tr>
      
      <td height="49">Proper Temperature </td>
      <td><input name="temp" type="text"  required/></td>
     
    </tr>
	<tr>
      
      <td height="49">Water requirement</td>
      <td><input name="water" type="text"  required/></td>
    ...
    <tr>
      ...
      <td height="49">weeding schedule</td>
      <td><input name="weed" type="text"  required/></td>
    ...
    <tr>
      ...
      <td height="49">Proper spacing</td>
      <td><input name="space" type="text"  required/></td>
