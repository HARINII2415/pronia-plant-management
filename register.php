...
$qry=mysqli_query($conn,"insert into register values('','$name','$email','$uname','$password')");
	if($qry)
	{
...
<body>
  ...
  <table width="36%" height="541" border="0" align="center" style="font-size:18px;margin:0 auto;">	
    ...
    <tr>
      ...
      <td width="44%" height="46"><span class="style6">Name</span></td>
      <td width="56%"><label>
