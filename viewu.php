...
if(isset($_POST['btn']))
{
			...
			$file_path=$_FILES['upload']['tmp_name'];
				...
				{ 
					...
					$img=$file_name;
					$qry=mysqli_query($conn,"insert into plant values('','$name','$dis','$ferti','$mois','$temp','$water','$weed','$space','$img','$sug')");
				if($qry)
							{
...
<body>
	...
	<tr>
		<td colspan="10" align="center"><strong><h3 style="text-decoration:underline;">Users Details</h3></strong></td>
	  </tr>
            ...
            <td width="12%"><div align="center" class="style6"><strong>S.NO</strong> </div></td>
		   <td width="12%"><div align="center" class="style6"><strong>Name</strong> </div></td>
		   <td width="12%"><div align="center" class="style6"><strong>Email</strong> </div></td>
		    <td width="13%"><div align="center" class="style6"><strong>Username</strong> </div></td>
